...
import com.barberapp.barberuser.utils.LoadingDialog;
import com.barberapp.barberuser.utils.RSAUtility;
...
//get rsa key method
    ...
    public void get_RSA_key(final String ac, final String od) {
        LoadingDialog.showLoadingDialog(WebViewActivity.this, "Loading...");
System.out.println("@@@@@@@@@@@@@@@@@@@@@"+mainIntent.getStringExtra(AvenuesParams.RSA_KEY_URL));
